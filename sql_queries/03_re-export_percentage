...
QUESTION:
Which importing countries showed the highest re-export volumes relative to their
total imports from 1990 to 2019?
GOAL:
To identify the key industrial hubs that import raw coffee to process (roast, package)
and re-export it to the global market.
*/
